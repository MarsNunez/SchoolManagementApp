  ...
  try {
    ...
    const courseSeed = [
      ...
      },
      {
        ...
        title: "Física I",
        description: "Movimiento, fuerza y energía.",
        teacher_id: "teacher-001",
        duration: 48,
      },
      {
        ...
        description: "Repaso cronológico desde las culturas preincas hasta la república.",
        teacher_id: "teacher-002",
        duration: 56,
      },
      {
        ...
        description: "Autores clásicos y contemporáneos.",
        teacher_id: "teacher-002",
        duration: 50,
      },
      {
      ...
      },
      {
        ...
        title: "Química I",
        description: "Química orgánica básica y reacciones.",
        teacher_id: "teacher-003",
        duration: 52,
      },
      {
        ...
        description: "Comprensión y producción oral.",
        teacher_id: "teacher-002",
        duration: 45,
      },
      {
        ...
        description: "Exploración de técnicas artísticas mixtas.",
        teacher_id: "teacher-002",
        duration: 40,
      },
      {
        ...
        description: "Fundamentos de programación y robótica educativa.",
        teacher_id: "teacher-001",
        duration: 60,
      },
      {
        course_id: "course-ethics-01",
        title: "Ética y Ciudadanía",
        description: "Formación en valores y convivencia escolar.",
        teacher_id: "teacher-002",
        duration: 38,
      },
    ];
    ...
    const syllabusSeed = [
      {
        ...
        description: "Plan académico para secundaria 2025.",
        year: 2025,
        courses: [
          "course-math-01",
          "course-physics-01",
    ...
    const postSeed = [
      {
        ...
        content: "Bienvenidos al año académico 2025. Revisen los horarios adjuntos.",
        links: [
      ...
      },
      {
        ...
        content: "Se convoca a reunión informativa el próximo viernes a las 7 p.m.",
        links: ["https://colegio.edu/agenda-reunion"],
        creator_id: "teacher-002",
      },
      {
        title: "Proyecto de laboratorio",
        content: "Los alumnos de ciencias presentarán sus proyectos finales la próxima semana.",
